...
import {signIn, oauthGoogle, oauthFacebok} from "../actions"
import CustomInput from "./CustomInput";
import GoogleLogin from "react-google-login";
import FacebookLogin from "react-facebook-login";

const SignIn = ({errorMessage, signIn, oauthGoogle, oauthFacebok, history}) => {
...
export default compose(
  connect(mapStateToProps, { signIn, oauthGoogle, oauthFacebok }),
